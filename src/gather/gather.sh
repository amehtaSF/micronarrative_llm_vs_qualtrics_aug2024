...
ROOT_DIR="/Users/ashish/files/research/projects/collab/petr_slovak/micronarrative_llm_vs_qualtrics_aug2024"
...
~/files/scripts/qualtrics_module.py responses SV_3n2vSiwXw9VvcpM --output_dir ${RAW_DIR}
