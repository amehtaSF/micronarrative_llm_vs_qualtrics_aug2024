...
class LLMConfig:
    ...
    def generate_questions_prompt_template(self, data_collection):
        ...
        questions_prompt += f"\nAsk each question one at a time as it is stated above. You can connect it to what the person said before, but make sure you stay close to the wording of the question while retaining the conversation's flow.  {data_collection['language_type']} "\
